...
export default {
  ...
  async getActivities({ commit }) {
    try {
      ...
      const messageToDisplay =
        "getActivities error: " + message.replace("GraphQL error: ", "");
      commit("addNotification", {
        type: messages.DANGER,
        text: messageToDisplay,
      });
  ...
  async resetActivityInformation({ commit }) {
    try {
      ...
      const messageToDisplay =
        "resetActivityInformation error: " +
  ...
  async getActivityById({ commit }, activityId) {
    try {
      ...
      const messageToDisplay =
        "getActivityById error: " + message.replace("GraphQL error: ", "");
      commit("addNotification", {
        type: messages.DANGER,
        text: messageToDisplay,
      });
  ...
  async getActivitiesList({ commit }) {
    try {
      ...
      const messageToDisplay =
        "getActivitiesList error: " + message.replace("GraphQL error: ", "");
      commit("addNotification", {
        type: messages.DANGER,
        text: messageToDisplay,
      });
  ...
  async deleteActivity({ commit }, info) {
    try {
      ...
      const messageToDisplay =
        "deleteActivity error: " + message.replace("GraphQL error: ", "");
      commit("addNotification", {
        type: messages.DANGER,
        text: messageToDisplay,
      });
