...
export default {
  ...
  async loginNew({ commit, dispatch }, data) {
    try {
      ...
      const messageToDisplay =
        "loginNew error: " + message.replace("GraphQL error: ", "");
      commit("addNotification", {
        type: messages.DANGER,
        text: messageToDisplay,
      });
  ...
  async login({ commit, dispatch }, { email, password, checkbox }) {
    try {
      ...
      const messageToDisplay =
        "Login error: " + message.replace("GraphQL error: ", "");
      commit("addNotification", {
        type: messages.DANGER,
        text: messageToDisplay,
      });
  ...
  async activateAccount({ commit }, data) {
    try {
      ...
      const messageToDisplay =
        "activateAccount error: " + message.replace("GraphQL error: ", "");
      commit("addNotification", {
        type: messages.DANGER,
        text: messageToDisplay,
      });
  ...
  async test({ commit }, data) {
    try {
      ...
      const messageToDisplay =
        "test error: " + message.replace("GraphQL error: ", "");
      commit("addNotification", {
        type: messages.DANGER,
        text: messageToDisplay,
      });
