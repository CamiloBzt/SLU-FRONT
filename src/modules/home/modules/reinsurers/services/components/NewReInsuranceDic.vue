    ...
    <div class="reinsurers-wrapper">
      ...
      <div class="reinsurers-inputs">
        <div class="input-width">
          <v-text-field label="Re-insurance name" v-model="reinsuranceRegistry.reInsuranceName"> </v-text-field>
        </div>
        <div class="input-width">
          <v-menu v-model="menu2" :close-on-content-click="false" :nudge-right="40" transition="scale-transition" offset-y min-width="auto">
            <template v-slot:activator="{ on, attrs }">
              <v-text-field v-model="reinsuranceRegistry.inceptionDateNewReInsuranceDic" label="Endorsement effective" v-bind="attrs" v-on="on"></v-text-field>
            </template>
            <v-date-picker v-model="reinsuranceRegistry.inceptionDateNewReInsuranceDic" @input="menu2 = false"></v-date-picker>
          </v-menu>
        </div>
        <div class="input-width">
          <v-text-field label="Expiry date" v-model="reinsuranceRegistry.expiryDateNewReInsuranceDic"> </v-text-field>
        </div>
      </div>
      ...
      <div class="reinsurers-Conditions">
        <div class="input-width-Conditions">
          <v-text-field label="Comission SLU" v-model="reinsuranceRegistry.comissionSluNewReInsuranceDic"> </v-text-field>
        </div>
        <div class="input-width-Conditions">
          <v-text-field label="To everglades re 1 DIC%" v-model="reinsuranceRegistry.evergladesRe1Dic"> </v-text-field>
        </div>
        <div class="input-width-Conditions">
          <v-text-field label="Everglades re 2 DIC%" v-model="reinsuranceRegistry.evergladesRe2Dic"> </v-text-field>
        </div>
        <div class="input-width-Conditions">
          <v-text-field label="Associated to" v-model="reinsuranceRegistry.associated"> </v-text-field>
        </div>
      </div>
      ...
      <div class="reinsurers-Conditions">
        <div class="input-width-Conditions">
          <v-text-field label="Maximum limit including BI" v-model="reinsuranceRegistry.maximumLimitIncludingBiNewReInsuranceDic"> </v-text-field>
        </div>
        <div class="input-width-Conditions">
          <v-text-field label="Maximum limit without BI" v-model="reinsuranceRegistry.maximumLimitWithoutBiNewReInsuranceDic"> </v-text-field>
        </div>
        <div class="input-width-Conditions">
          <v-text-field label="Deductions" v-model="reinsuranceRegistry.deductionsNewReInsuranceDic"> </v-text-field>
        </div>
        <div class="input-width-Conditions">
          <v-text-field label="Maximum line" v-model="reinsuranceRegistry.maximumLineNewReInsuranceDic"> </v-text-field>
        </div>
      </div>
    </div>
