    ...
    <div class="endorsement-wrapper">
      <div class="content">
        <div class="head-items-cont">
          <div class="endorsement-title" style="padding: 20px">New Total Insured Value</div>
        </div>
                    ...
                    <div class="inner-col wide-col">
                      <div class="table-input blue-input">
                        <currency-input
                          ...
                          "
                          :disabled="item.name == 'Original Currency'"
                          :readonly="!showTable"
                        />
                      </div>
...
export default {
  ...
  methods: {
    sumTotalPremium() {
      const admittedPremium = this.detailValues[0].datas.find((el) => el.id === 1);
      const sum = admittedPremium.damage + admittedPremium.bi + admittedPremium.stocks;
      return sum;
    },
    sumPremiumSlu() {
      const admittedPremium = this.detailValues[0].datas.find((el) => el.id === 1);
