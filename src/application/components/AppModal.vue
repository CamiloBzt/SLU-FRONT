		...
		<div class="modal">
			...
			<div class="modal__form">
				...
				<h2 class="modal-title">
					This account will change his status for bound complete. <br /> 
					Are you shure this action?
				</h2>
				<!-- Finish button -->
				<div class="finish-button">
					<v-btn rounded depressed @click="emitConfirmation">
						Confirm
					</v-btn>
					<v-btn class="v-btn--outlined" rounded depressed @click="emitCloseModal">
						Cancel
					</v-btn>
				</div>
			</div>
