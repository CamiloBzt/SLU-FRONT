    ...
    <div class="TableContent">
      ...
      <div class="TableBodyContent mt-4">
        <div class="TableContentInner scrollable" ref="tableContentInner">
          ...
          class="TableBodyContSn table-line d-flex justify-center text-center align-start" :style="{ width: tableBodyContSnWidth > 0 ? `${tableBodyContSnWidth}px` : '100%' }">
            ...
            <div class="TableBodyText d-flex justify-center align-center row11">
