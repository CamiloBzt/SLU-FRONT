...
import { sluShare,  calculateProperty, calculateTotal, calculateNet } from './utils'
...
class  NetPremiumNonPro {
   ...
   */
    ...
    damageSluShare(){
        const value  =  (!this.usd  ? this.premium.propertyDamage  : this.premium.propertyDamageUsd) || 0
    ...
    biSluShare(){
        const value  =  !this.usd  ? this.premium.businessInterruption : this.premium.businessInterruptionUsd
        const result = sluShare(this.sluLine,value)
