<template>
  <v-expansion-panels class="ExpansionComponent">
    <v-expansion-panel>
      <!--TITULO DEL ACORDEON-->
      <v-expansion-panel-header @click="changeStateExpansive()" class="ExpansionTitle" expand-icon="mdi-plus-circle-outline">
        Account information
        ...
        <div class="ExpandContent">
          ...
          <div class="FormLeftContent d-flex justify-space-between align-start align-content-start flex-wrap">
            ...
            <div class="InputContent">
              <v-text-field v-model="referenceNumber" label="Reference number"></v-text-field>
            </div>
            <div class="InputContent">
              <v-text-field v-model="insured" label="Insured"></v-text-field>
            </div>

            <div class="InputContent">
              <v-text-field v-model="tiv" label="TIV"></v-text-field>
            </div>
            <div class="InputContent">
              <v-text-field v-model="pml" label="PML (100% in $)"></v-text-field>
            </div>

            <div class="InputContent">
              <v-text-field v-model="qs" label="QS Technical Premium"></v-text-field>
            </div>
            <div class="InputContent">
              <v-text-field v-model="pmlCurve" label="PML Curve"></v-text-field>
            </div>

            <div class="InputContent">
              <v-text-field v-model="comission" label="Commission"></v-text-field>
            </div>
            <div class="InputContent">
          ...
          <div class="FormRightContent d-flex justify-space-between align-start align-content-start flex-wrap">
            ...
            <div class="InputContent">
              <v-text-field v-model="xs" label="XS of"></v-text-field>
            </div>
          </div>
