<template>
  <v-dialog v-model="dialog" width="600">
    <v-card id="card-eye" class="pb-3">
      ...
      <v-card-title class="font-weight-bold text-h5">Confirmation Four eyes law</v-card-title>
      <v-divider id="divisor"></v-divider>
      <div id="border-blue" class="mb-8">
        <v-card-text class="font-weight-bold text-h6 blue-text">You have sent David Acosta a review request.</v-card-text>
        <v-divider id="divisor"></v-divider>
      </div>
    </v-card>
  </v-dialog>
