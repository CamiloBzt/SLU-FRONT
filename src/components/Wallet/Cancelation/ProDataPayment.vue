    ...
    <v-expansion-panel>
      ...
      <v-expansion-panel-content>
        <div class="ExpandContent justify-center">
          <!--Subtitulo-->
          <h5 class="SubTitle">Pro rata payment premium for the period</h5>

          <!--Contenedor de dos tablas-->
          <div class="TableContent">
            <!--Tabla-->
            <div class="Table">
              <div class="Line font-weight-bold justify-center BorderBottom">USD</div>

              <div class="Line">
                <div class="Row Label bold">Gross Premium Deductions</div>
              ...
              <div class="Line BorderBottom">
                <div class="Row Label">Fronting</div>
                <div class="Row align-center">
                  <v-text-field value="10%" />
                </div>
                <div class="Row align-right">
              ...
              <div class="Line">
                <div class="Row Label bold">Net Premium</div>
                <div class="Row align-center">
                  <v-text-field value="10%" />
                </div>
                <div class="Row align-right">
            ...
            <!--Tabla-->
            <div class="Table">
              <div class="Line font-weight-bold justify-center BorderBottom">Original Currency</div>
          ...
          <!--Subtitulo-->
          <h5 class="SubTitle mt-5">Premium payment pro rata for the period</h5>
          ...
          <div class="ButtonCont d-flex justify-end align-center">
            <v-btn depressed color="#003D6D" rounded> Cancel </v-btn>
          </div>
        </div>
      </v-expansion-panel-content>
    </v-expansion-panel>
